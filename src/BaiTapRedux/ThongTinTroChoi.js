...
class ThongTinTroChoi extends Component {
    render() {
        return (
            <div>
                <div className='display-4'>BẠN CHỌN: <span className="text-success">{this.props.taiXiu ? 'TÀI' : 'XỈU'}</span></div>

                <div className='display-4'>BÀN THẮNG: <span className="text-danger">{this.props.soBanThang}</span></div>
